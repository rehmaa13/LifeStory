    ...
    var body: some View {
        ZStack {
            ...
            VStack{
                VStack {
                    HStack {
                        TextField("Untitled Story", text: $noteTitle, onCommit: {
                            ...
                            .alert(isPresented: $noteTitleAlert) {
                                Alert(
                                    ...
                                    message: Text("Make sure you give your story a title."),
                    ...
                    HStack (alignment: .top){
                        ...
                        MultilineTextFieldView("", text: $noteBody, characterLimit: charLimit, onCommit: {
                            ...
                            .alert(isPresented: $noteBodyAlert) {
                                Alert(
                                    title: Text("Blank story"),
                                    message: Text("Make sure you give your story some content."),
                                    dismissButton: .default(Text("OK"))
                                )
                        }
                        .animation(.none)
